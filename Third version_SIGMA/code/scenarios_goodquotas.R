...
#-------------------------------------------------------------------------------
#LndQuotaMAC= 73 / 15 vessels = 4.86
#LndQuotaHKE= 5919/ 15 = 394.6 

#60 increments, sizeincrements for mac is 4.23
...
#-------------------------------------------------------------------------------
#LndQuotaMAC= 6 / 15 vessels = 0.4
#LndQuotaHOM= 1678/ 15 = 111.86 
...
control <- DynState.control(spp1LndQuota= 2,  spp2LndQuota= 112, #tn
                            spp1LndQuotaFine= 1E9, spp2LndQuotaFine=1E9, # tn
                            fuelUse =1 , 
                            fuelPrice = 1240, # euros/day
                            landingCosts= 121, # euros/tn
...
#LndQuotaMAC= 519 / 15 vessels = 34.6
#LndQuotaHKE= 5583/ 15 = 372.2 

control <- DynState.control(spp1LndQuota= 35,  spp2LndQuota= 372, #tn
                            spp1LndQuotaFine= 1E9, spp2LndQuotaFine=1E9, # tn
                            fuelUse =1 , 
                            fuelPrice = 1240, # euros/day
                            landingCosts= 121, # euros/tn
